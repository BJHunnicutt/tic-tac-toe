...
/***/ function(module, exports, __webpack_require__) {
	...
	var _application_view = __webpack_require__(305);

	var _application_view2 = _interopRequireDefault(_application_view);
	...
	(0, _jquery2.default)(document).ready(function () {
	  ...
	  var appView = new _application_view2.default({
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(301), __webpack_require__(299), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _square = __webpack_require__(303);
	...
	var Game = _backbone2.default.Model.extend({
	  ...
	  initialize: function initialize() {
	    ...
	    var squares = base_board.map(function (contents) {
	      return new _square2.default({ "contents": contents });
	    });
	    this.board = new _board2.default(squares); // Alternatively, you can use loop above and put squares instead of base_board.squares, but that loop happens automatically in the Board collection setup
	  ...
	  reset_board: function reset_board() {
	    ...
	    this.board = new _board2.default(squares);
	  },

	  updateOutcomes: function updateOutcomes(outcome) {
	    if (outcome === "tie") {
	      var o = this.get("outcomes");
	      o[1] = o[1] + 1;
	      this.set("outcomes", o);
	    } else if (outcome === "X") {
	      var _o = this.get("outcomes");
	      _o[0] = _o[0] + 1;
	      this.set("outcomes", _o);
	    } else if (outcome === "O") {
	      var _o2 = this.get("outcomes");
	      _o2[2] = _o2[2] + 1;
	      this.set("outcomes", _o2);
	    }
	  },

	  formatGameForAPI: function formatGameForAPI(outcome) {
	    // Initialize the JSON data needed for the API
	    var formatted = { "board": [], "players": [], "outcome": "" };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Square = _backbone2.default.Model.extend({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Board = _backbone2.default.Collection.extend({
	  ...
	  checkWin: function checkWin() {
	    ...
	    try {
	      for (var _iterator = symbols[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	        ...
	        for (var _i = 0; _i < _arr.length; _i++) {
	          var i = _arr[_i];
	          var a = 0 + parseInt(i);var b = 1 + parseInt(i);var c = 2 + parseInt(i);var a1 = 0 + parseInt(i) + 1;var b1 = 1 + parseInt(i) + 1;var c1 = 2 + parseInt(i) + 1;
	          if (ba[a] == s && ba[b] == s && ba[c] == s) {
	            // Highlight the winning row in the view (I know i probably shouldn't be doing this here)
	            (0, _jquery2.default)(".symbol-card:nth-child(" + a1 + ") h4").css("text-shadow", "0px 0px 20px gold");
	            (0, _jquery2.default)(".symbol-card:nth-child(" + b1 + ") h4").css("text-shadow", "0px 0px 20px gold");
	            (0, _jquery2.default)(".symbol-card:nth-child(" + c1 + ") h4").css("text-shadow", "0px 0px 20px gold");
	        ...
	        for (var _i2 = 0; _i2 < _arr2.length; _i2++) {
	          var _i3 = _arr2[_i2];
	          var x = 0 + parseInt(_i3);var y = 3 + parseInt(_i3);var z = 6 + parseInt(_i3);var x1 = 0 + parseInt(_i3) + 1;var y1 = 3 + parseInt(_i3) + 1;var z1 = 6 + parseInt(_i3) + 1;
	          if (ba[x] == s && ba[y] == s && ba[z] == s) {
	            // Highlight the winning row in the view (I know i probably shouldn't be doing this here)
	            (0, _jquery2.default)(".symbol-card:nth-child(" + x1 + ") h4").css("text-shadow", "0px 0px 20px gold");
	            // $(".symbol-card:nth-child("+ x1 +") h4").css( "color", "white");
	            (0, _jquery2.default)(".symbol-card:nth-child(" + y1 + ") h4").css("text-shadow", "0px 0px 20px gold");
	            // $(".symbol-card:nth-child("+ y1 +") h4").css( "color", "white");
	            (0, _jquery2.default)(".symbol-card:nth-child(" + z1 + ") h4").css("text-shadow", "0px 0px 20px gold");
	        ...
	        if (ba[0] == s && ba[4] == s && ba[8] == s) {
	          // Highlight the winning row in the view (I know i probably shouldn't be doing this here)
	          (0, _jquery2.default)(".symbol-card:nth-child(" + 1 + ") h4").css("text-shadow", "0px 0px 20px gold");
	          (0, _jquery2.default)(".symbol-card:nth-child(" + 5 + ") h4").css("text-shadow", "0px 0px 20px gold");
	          (0, _jquery2.default)(".symbol-card:nth-child(" + 9 + ") h4").css("text-shadow", "0px 0px 20px gold");

	          // Return the winning symbol
	          return s;
	        } else if (ba[2] == s && ba[4] == s && ba[6] == s) {
	          // Highlight the winning row in the view (I know i probably shouldn't be doing this here)
	          (0, _jquery2.default)(".symbol-card:nth-child(" + 3 + ") h4").css("text-shadow", "0px 0px 20px gold");
	          (0, _jquery2.default)(".symbol-card:nth-child(" + 5 + ") h4").css("text-shadow", "0px 0px 20px gold");
	          (0, _jquery2.default)(".symbol-card:nth-child(" + 7 + ") h4").css("text-shadow", "0px 0px 20px gold");
	    ...
	    if (![].concat.apply([], ba).includes(' ')) {
	      //That is essentially array.flatten.include?
	      return "tie";
	    } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _board_view = __webpack_require__(306);
	...
	var ApplicationView = _backbone2.default.View.extend({
	  initialize: function initialize() {
	    ...
	    this.gameOverTemplate = _underscore2.default.template(_backbone2.default.$('#tmpl-end-game').html());
	  ...
	  displayEndGame: function displayEndGame(event) {

	    var outcome = this.model.board.checkWin();
	  ...
	  hideModal: function hideModal(e) {
	    ...
	    var modalElement = this.gameOverModal[0];
	    var clickedOnModal = modalElement == e.target; // OR (modalElement == e.target || Backbone.$.contains(modalElement, e.target)); //If you also want to include clicking on elements inside the modal, but I want it to close if a button is clicked.
	  ...
	  toggleBackground: function toggleBackground() {
	    if ((0, _jquery2.default)("#bg-image").is(':visible')) {
	      (0, _jquery2.default)("#bg-image").fadeOut();
	      (0, _jquery2.default)("#bg-overlay").fadeOut();
	      (0, _jquery2.default)("#background-toggle").html(":( ");
	    } else {
	      (0, _jquery2.default)("#bg-image").show();
	      (0, _jquery2.default)("#bg-overlay").fadeIn();
	      (0, _jquery2.default)("#background-toggle").html(":)");
	    }
	  },
	  ...
	  render_scores: function render_scores() {
	    ...
	    (0, _jquery2.default)('#player1-details').html(score_details[0]);
	    (0, _jquery2.default)('#tie-details').html(score_details[1]);
	    (0, _jquery2.default)('#player2-details').html(score_details[2]);
	  },

	  render: function render() {
	    // console.log(this.model.get("turn"));
	    var boardView = new _board_view2.default({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _square_view = __webpack_require__(307);

	var _square_view2 = _interopRequireDefault(_square_view);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var BoardView = _backbone2.default.View.extend({
	  initialize: function initialize() {
	  ...
	  playSymbol: function playSymbol(card) {
	    ...
	    if (this.checkPlacement(card)) {
	      ...
	      var currentPlayer = void 0;var nextPlayer = void 0;
	      if (turn === "X") {
	      ...
	      (0, _jquery2.default)(currentPlayer).css("background-color", "rgba(255,255,255,0)");
	      (0, _jquery2.default)(nextPlayer).css("background-color", "rgba(255, 215, 0, 0.85)");
	  ...
	  checkPlacement: function checkPlacement(card) {
	  ...
	  render: function render() {
	    ...
	    var cardList = this.$('#symbol-cards');
	    cardList.empty();

	    this.collection.forEach(function (square) {
	      var card = new _square_view2.default({
	        model: square
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SquareView = _backbone2.default.View.extend({
	  ...
	  initialize: function initialize() {
	    this.template = _underscore2.default.template(_backbone2.default.$('#tmpl-symbol-card').html()); // Backbone does not seem to matter
	  },
	  ...
	  selectSquare: function selectSquare(e) {
